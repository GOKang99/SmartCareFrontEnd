    ...
    <div className="fixed inset-0 flex items-center justify-center bg-opacity-50">
      ...
      {!showCompositionForm ? (
        ...
        <div className="fixed inset-0 flex items-center justify-center">
          <div className="bg-white w-[800px] p-6 rounded-lg shadow-lg border border-black">
            <CompositionForm resident={resident} />
            <div className="flex justify-end">
              <button
                onClick={() => setShowCompositionForm(false)}
                className="mt-4 bg-white hover:bg-gray-100 text-black border border-gray-700 font-medium py-1 px-3 rounded-md shadow-sm transition duration-300 text-sm"
              >
                돌아가기
              </button>
            </div>
